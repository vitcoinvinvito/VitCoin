...
const QString BITCOIN_IPC_PREFIX("VitCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click VitCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start VitCoin: click-to-pay handler");
    else
...
{
    // clicking on VitCoin: URLs creates FileOpen events on the Mac:
